...
| 3 | `cargo test --workspace --all-features` | 0 | PASS (234 tests: 24 boa_fapi unit, 10 boa_fapi guards, 51 M2 JS integration, 16 M3-A JS integration, 1 boa_fapi doc, 132 core: 50+25+7+17+16+19) |
...
| 8 | `cargo llvm-cov --package boa_fapi --all-features --fail-under-lines 85` | 0 | PASS (92.29% lines, threshold 85%) |
...
promise_read.rs                   332                39    88.25%          21                 5    76.19%         202                20    90.10%           0                 0         -
webidl.rs                         632                71    88.77%          41                 4    90.24%         387                33    91.47%           0                 0         -
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
TOTAL                            1812               187    89.68%         119                12    89.92%        1167                90    92.29%           0                 0         -
```

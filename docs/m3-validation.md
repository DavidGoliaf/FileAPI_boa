...
| 3 | `cargo test --workspace --all-features` | 0 | PASS (235 tests: 25 boa_fapi unit, 10 boa_fapi guards, 51 M2 JS integration, 16 M3-A JS integration, 1 boa_fapi doc, 132 core: 50+25+7+17+16+19) |
...
| 8 | `cargo llvm-cov --package boa_fapi --all-features --fail-under-lines 85` | 0 | PASS (92.42% lines, threshold 85%) |
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
TOTAL                            1788               182    89.82%         120                12    90.00%        1174                89    92.42%           0                 0         -
```

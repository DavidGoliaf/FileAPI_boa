...
| 9 | `cargo llvm-cov --package boa_fapi --all-features --fail-under-lines 85` | 0 | PASS (89.81% lines, threshold 85%) |
...
extension.rs                      296                38    87.16%          20                 1    95.00%         214                19    91.12%           0                 0         -
...
-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
TOTAL                            2878               383    86.69%         172                23    86.63%        1933               197    89.81%           0                 0         -
```

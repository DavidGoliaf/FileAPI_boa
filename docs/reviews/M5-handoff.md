...
- Final code commit SHA: `e23e0721e885561deda52c211075ed389dfd3cca`
...
(`e23e072`) is green in the final CI run above. Unix-only live-handle
tests executed in the Ubuntu job; Windows executed the refusal +
copy-fallback tests.
